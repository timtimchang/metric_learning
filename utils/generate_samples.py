...
if(len(sys.argv) != 5):
    print ("\nusage: python generate_samples.py dimension num_samples start_idx end_idx\n")
    sys.exit()
...
for i in range(start, end):
    ...
    directory = '../data/sphere_sample_' + temp_str 
    if not os.path.exists(directory):
            os.makedirs(directory)

    file_name = directory + '/' + temp_str + '_' + str(i) + '.npy'
    np.save(file_name, samples)
    print("generate_samples success")
